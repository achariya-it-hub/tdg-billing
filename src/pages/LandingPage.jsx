    ...
    <section style={{ padding: '80px 40px', backgroundColor: '#1a1c1e', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
          style={{
            background: 'linear-gradient(135deg, rgba(230, 57, 70, 0.08) 0%, rgba(255, 215, 0, 0.03) 100%)',
        ...
        >
          ...
          <div style={{
            ...
            background: 'rgba(230, 57, 70, 0.15)', borderRadius: '50%', filter: 'blur(50px)', pointerEvents: 'none'
          }} />
          <div style={{
            position: 'absolute', bottom: '-50px', right: '-50px', width: '200px', height: '200px',
            background: 'rgba(255, 215, 0, 0.1)', borderRadius: '50%', filter: 'blur(50px)', pointerEvents: 'none'
          }} />

          <span style={{ fontSize: '13px', color: '#ffd700', fontWeight: 800, letterSpacing: '3px', textTransform: 'uppercase', display: 'block', marginBottom: '12px' }}>
            Interactive Customizer
          </span>
          <h2 style={{ fontSize: '40px', fontWeight: 950, letterSpacing: '1px', textTransform: 'uppercase', color: '#fff', marginBottom: '16px' }}>
            CREATE YOUR OWN GYRO Wrap 🌯
          </h2>
          <p style={{ color: '#9ca3af', fontSize: '16px', maxWidth: '640px', margin: '0 auto 32px auto', lineHeight: 1.6 }}>
            Mix and match fresh chicken or paneer, baked flatbreads, house spreads, and custom veggies to craft the ultimate Mediterranean flavor wrap.
          </p>
