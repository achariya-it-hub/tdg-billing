...
gyro_inventory_additions = [
    ...
    { "id": "inv_spicy_paneer", "name": "Spicy Paneer Cooked", "category": "Raw Material", "unit": "kg", "costPerUnit": 451.89, "currentStock": 100, "minimumStock": 10 }
]

gyro_recipes_additions = [
    # Pesto Gyro Chicken Mini
    {
        "id": "r_m11a",
        "menuItemId": "m11a",
    ...
    # Pesto Gyro Chicken Signature Large
    {
        "id": "r_m12a",
        "menuItemId": "m12a",
    ...
    # Spicy Gyro Paneer Signature Large
    {
        "id": "r_m2b",
        "menuItemId": "m2b",
    ...
    if os.path.exists(fpath):
        try:
            ...
            if isinstance(data, dict):
                ...
                for item in gyro_inventory_additions:
                ...
                for r in gyro_recipes_additions:
                    recipe_map[r['menuItemId']] = r
                data['recipes'] = list(recipe_map.values())

                with open(fpath, 'w', encoding='utf-8') as f:
                    json.dump(data, f, indent=2)
                print(f"Updated {fpath} successfully with Gyro recipes!")
