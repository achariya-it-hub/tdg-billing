...
print("=== TDG Billing — Deploying 58 New Menu Items with Original HD Images ===")
...
if os.path.exists(db_path):
    ...
    backup_data = {
        ...
        "timestamp": "2026-08-15T08:44:00.000Z"
    }
...
# Step 3: Define New Menu Items with Original High-Res Image Paths (58 Items)
new_menu_items = [
    # Gyros
...
print(f"Created {len(new_categories)} Categories, {len(new_menu_items)} Menu Items with HD images, {len(new_recipes)} Recipes.")
...
print("=== Menu update with HD images completed successfully! ===")
